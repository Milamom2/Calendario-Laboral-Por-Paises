...
public class FestivoServicio implements IFestivoServicio {
    ...
    public LocalDate calcularFechaFestivo(Festivo festivo, int anio) {
        ...
        String tipo = festivo.getTipoFestivo()
                             .getTipo()
                             .trim()
                             .toUpperCase();
        ...
        switch (tipo) {
            ...
            default:
                throw new IllegalArgumentException(
                        "Tipo de festivo no soportado: " + tipo
                );
        }
    }
    ...
    public boolean esFestivo(Long idPais, LocalDate fecha) {
        ...
        for (Festivo festivo : festivos) {
            ...
            LocalDate calculada =
                    calcularFechaFestivo(festivo, fecha.getYear());
    ...
    @Override
    public List<LocalDate> listarFechasFestivasPorPaisYAnio(
            Long idPais,
            int anio
    ) {
        ...
        for (Festivo festivo : festivos) {
            ...
            fechas.add(
                    calcularFechaFestivo(festivo, anio)
            );
        }
  ...
  @Override
public DiaCalendarioDTO generarCalendario(int anio, Long idPais) {

    DiaCalendarioDTO dto = new DiaCalendarioDTO();
